...
WITH cte1 as(
SELECT dp.segment, COUNT(dp.product_code) as product_count_2020 FROM dim_product dp
...
cte2 as(
SELECT dp.segment, COUNT(dp.product_code) as product_count_2021 FROM dim_product dp
JOIN fact_sales_monthly fsm
ON fsm.product_code=dp.product_code
